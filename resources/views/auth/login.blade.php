...
@section('page-title',Lang::get('labels.login'))
<body>
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4 col-md-offset-4" style="margin-top:80px;">
            <div class="panel text-center">
                <div style="padding-bottom: 10px;">Say AdWords, think </div>
                     {{--{!! Html::image(asset('images/GCM-Logo.png')) !!}--}}
                   {{--changed width to max-width , otherwise SVG is not responsive --}}
                <div class="login-logo">
                <svg style="color: #000; max-width: 470px;" id="gcm-logo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180.1 23">
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4 col-xs-offset-1"  style="margin-top:40px;">
			<div class="panel panel-green">
				<div class="panel-heading">Ready to kick-ass?</div>
				<div class="panel-body">
					@if (count($errors) > 0)
						<div class="alert alert-danger">
							<strong>Whoops!</strong> @lang('messages.input-problems')<br><br>
							<ul>
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/login') }}">
                        ...
                        <input type="hidden" name="returnUrl" value="{{$returnUrl or ''}}">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user" title="@lang('labels.username')"></i></span>
                                    <input type="text" class="form-control" name="username" placeholder="@lang('labels.username')" value="{{ old('username') }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-lock" title="@lang('labels.password')"></i></span>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-md-offset-0">
                                <button type="submit" class="btn btn-orange form-control">@lang('labels.login')</button>
                            </div>
                        </div>
					</form>
    ...
    <div class="row">
        <div class="panel">
            <div class="video text-center">
                        <img src="../images/google-logo.jpg" height="150" />
               <!--<iframe width="470" height="300" src="https://www.youtube.com/embed/ANS0HInIH3I" frameborder="0" allowfullscreen></iframe>-->
            </div>
        </div>
    </div>
</div>
