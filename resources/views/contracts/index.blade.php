@extends('layout.main')
@section('page-title',Lang::get('labels.contracts'))
@section('scripts')
...
$(document).ready(function(){
    ...
    stateSave : true,
        ...
        "sAjaxSource": api_address+"Contracts?$expand=ClientAlias($select=Id,Name),Country,Product($select=Id,Name,Description),User($select=Id,UserName),Manager($select=Id,FullName),Children($select=Id;$expand=Product($select=Name))",
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-6">
                            <div class="form-group-sm col-md-3">
                                {!! Form::select('Status',$contractStatus,"Status eq 'Active'",['class'=>'form-control contractFilters']) !!}
                            </div>
                            <div class="form-group-sm col-md-3">
                                {!! Form::select('Manager_Id',withEmpty($managers,Lang::get('labels.select-assigned')),"Manager_Id eq '".Auth::user()->externalId."'",['class'=>'form-control contractFilters']) !!}
                            </div>
                            <div class="form-group-sm col-md-3">
