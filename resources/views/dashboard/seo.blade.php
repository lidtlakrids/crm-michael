    ...
    <script>
        $(document).ready(function () {
            ...
            function dashboardStats(){
                ...
                $.get(api_address+"Contracts/$count?$filter=Status eq 'Active' and NeedInformation eq false and NextOptimize ne null and NextOptimize lt "+getIsoDate(DayStart)+optimizationsQuery)
                        .success(function (data){
        ...
        <div class="col-md-12">
            <div class="panel panel-sales">
                <div class="panel-heading">
                    <h4><i class="fa fa-tachometer"></i> SEO @lang('labels.dashboard')</h4>
